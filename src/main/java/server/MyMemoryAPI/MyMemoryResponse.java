...
public class MyMemoryResponse {
    ...
    @JsonProperty("quotaFinished")
    public void setQuotaFinished(boolean value) {
        this.quotaFinished = value;
    }
    ...
    @JsonProperty("mtLangSupported")
    public void setMTLangSupported(Object value) {
        this.mtLangSupported = value;
    }
    ...
    @JsonProperty("responseStatus")
    public void setResponseStatus(long value) {
    ...
    @JsonProperty("exception_code")
    public void setExceptionCode(Object value) {
